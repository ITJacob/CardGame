...
**轴元数据现状（2026-09-22 复核）**：88 轴 | statusId 可解析 38 | 未填（合法）50 | 悬空 **0** | 缺 enablers 38 | 缺 payoffs 67（09-20 记 71，期间补 4 条）。缺 enablers 的 38 轴 `statusId` 全为空，须逐轴评审。
