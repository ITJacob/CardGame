...
2. **旧编号速查在 brief §7**：技能稿引用的 A–H 组 / v1.5 A1–A24 编号，落点全部并入 `_GENERATION_BRIEF.md` §7–§9。`LEGACY_REFS.md`、`框架改动记录.md`、`待拍板清单_来自v1.5.md` 均已删除，**不要引用**（原文在 git 历史）。⚠️ A 编号有两套来源，引用前查 §7 区分。
